   ...
   * */
      ...
      function validate_shape (obj, expected, super_node = 'root', path = '') {
        ...
        Object.entries(expected).forEach(([expected_key, expected_value]) => {
          ...
          if (expected_key_names) {
            expected_key_names.split('|').forEach(expected_key_name => {
              ...
              if (value !== undefined) {
                ...
                if (expected_types.includes(type)) { type === 'object' && validate_shape(value, expected_value, expected_key_name, path + '/' + expected_key_name) } else { throw new Error(`Type mismatch: Expected "${expected_types.join(' or ')}" got "${type}" for key "${expected_key_name}" at:` + path) }
              }
            })
          } else {
          ...
          if (absent && required) {
            if (expected_key_names) { throw new Error(`Can't find required key "${expected_key_names.replace('|', ' or ')}" at: ` + path) } else { throw new Error(`No subnodes found for super key "${super_node}" at sub: ` + path) }
          }
        })
      }
    }
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example2/node_modules/app.js')
  }, { STATE: 2, foot: 6, head: 7 }],
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example2/node_modules/btn.js')
  }, { STATE: 2, icon: 8 }],
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example2/node_modules/foot.js')
  }, { STATE: 2, text: 11 }],
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example2/node_modules/head.js')
  }, { STATE: 2, foo: 5 }],
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example2/node_modules/icon.js')
  }, { STATE: 2 }],
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example2/node_modules/menu.js')
  }, { STATE: 2, btn: 4 }],
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example2/node_modules/nav.js')
  }, { STATE: 2, menu: 9 }],
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example2/node_modules/text.js')
  }, { STATE: 2 }],
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example2/page.js', '/doc/state/example2')
  }, { STATE: 2, app: 3 }],
