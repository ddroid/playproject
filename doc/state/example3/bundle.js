(function () { function r (e, n, t) { function o (i, f) { if (!n[i]) { if (!e[i]) { const c = typeof require === 'function' && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); const a = new Error("Cannot find module '" + i + "'"); throw a.code = 'MODULE_NOT_FOUND', a } const p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { const n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = typeof require === 'function' && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
  ...
  2: [function (require, module, exports) {
    ...
    }).call(this, '/doc/state/example3/node_modules/app.js')
  }, { '../../../../src/node_modules/STATE': 6, btn: 3, text: 4 }],
  3: [function (require, module, exports) {
      ...
      (function () {
        ...
        async function btn (opts) {
          ...
          async function btn_click (event) {
            ...
            const isToggled = button_el.dataset.toggled === 'true'
            if (isToggled) {
    ...
    }).call(this, '/doc/state/example3/node_modules/btn.js')
  }, { '../../../../src/node_modules/STATE': 6 }],
  4: [function (require, module, exports) {
    ...
    }).call(this, '/doc/state/example3/node_modules/text.js')
  }, { '../../../../src/node_modules/STATE': 6 }],
...
******************************************************************************/
    ...
    }).call(this, '/doc/state/example3/page.js')
  }, { '../../../src/node_modules/STATE': 6, app: 2 }],
   ...
   * */
          ...
          if (expected_key_names) {
            expected_key_names.split('|').forEach(expected_key_name => {
              ...
              if (value !== undefined) {
                ...
                if (expected_types.includes(type)) { type === 'object' && validate_shape(value, expected_value, expected_key_name, path + '/' + expected_key_name) } else { throw new Error(`Type mismatch: Expected "${expected_types.join(' or ')}" got "${type}" for key "${expected_key_name}" at:` + path + fallback_post_error) }
              }
            })
          } else {
            values.forEach((value, index) => {
              ...
              if (expected_types.includes(type)) { type === 'object' && validate_shape(value, expected_value, keys[index], path + '/' + keys[index]) } else { throw new Error(`Type mismatch: Expected "${expected_types.join(' or ')}" got "${type}" for key "${keys[index]}" at: ` + path) }
            })
          }
          if (absent && required) {
            if (expected_key_names) { throw new Error(`Can't find required key "${expected_key_names.replace('|', ' or ')}" at: ` + path + fallback_post_error) } else { throw new Error(`No sub-nodes found for super key "${super_node}" at sub: ` + path + fallback_post_error) }
          }
        })
      }
    }
    ...
    function verify_imports (id, imports, data) {
      ...
      imports.forEach(imp => {
        ...
        if (check) { throw new Error('Required module "' + imp + '" is not defined in the fallback of ' + status.local_statuses[id].module_id + fallback_post_error) }
      })
      ...
      fallback_imports.forEach(fallimp => {
        ...
        if (check) { throw new Error('Module "' + fallimp + '" defined in the fallback of ' + status.local_statuses[id].module_id + ' is not required') }
      })
    }
