...
async function btn1 (opts) {
    ...
    button_el.onclick = () => {
    //ISSUE#4: This does not make sense what are all these variables doing here they are not defined anywhere. And those APIs can't and are not meant to be used like that.
